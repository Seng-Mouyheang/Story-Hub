  ...
  return (
    <div className="flex h-screen">
      ...
      <main className="flex-1 bg-slate-50/50 min-h-screen flex flex-col overflow-y-auto">
        ...
        <div className="p-8 max-w-3xl mx-auto w-full flex flex-col items-center justify-start pt-12">
          ...
          <div className="bg-black text-white p-12 rounded-[40px] text-left relative overflow-hidden w-full max-w-2xl">
